...
<html lang="en">
        ...
        <div class="page-container">
            ...
            <div class="page-sidebar">
                ...
                <ul class="x-navigation">
                    ...
                    <li class="active">
                        <a href="{$base_url}Timeline"><span class="fa fa-dashboard"></span> <span class="xn-text">Timeline</span></a>
                    </li>                    
                    <li class="active">
                        <a href="{$base_url}Profile"><span class="fa fa-files-o"></span> <span class="xn-text">Profile</span></a>
                    </li>
                    <li class="active">
                        <a href="{$base_url}Assessment"><span class="fa fa-file-text-o"></span> <span class="xn-text">Assessment</span></a>
                    </li>
    ...
    <!-- START SCRIPTS -->
        ...
        <script type="text/javascript" src="{$assets_url}js/plugins/rickshaw/d3.v3.js"></script>
        <script type="text/javascript" src="{$assets_url}js/plugins/rickshaw/rickshaw.min.js"></script>
        <script type='text/javascript' src='{$assets_url}js/plugins/jvectormap/jquery-jvectormap-1.2.2.min.js'></script>
        <script type='text/javascript' src='{$assets_url}js/plugins/jvectormap/jquery-jvectormap-world-mill-en.js'></script>                
        <script type='text/javascript' src='{$assets_url}js/plugins/bootstrap/bootstrap-datepicker.js'></script>                
